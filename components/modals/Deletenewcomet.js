...
import { deleteUpcomeingComet } from "../../redux/actions/comet";

const Deletenewcomet = ({
  setShowDeletePopup,
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Add New Comet</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <h2 className="popup-title">
            Are you sure you want to delete this comet ?
          </h2>
        </Modal.Body>
        <Modal.Footer>
